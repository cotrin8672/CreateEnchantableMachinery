    ...
    fun enchanting(builder: SceneBuilder, util: SceneBuildingUtil) {
        ...
        with(CreateSceneBuilder(builder)) {
            ...
            overlay().showText(50)
                ...
                .text("The Crushing Wheel can be enchanted with Efficiency enchantments")
            idle(60)
            ...
            overlay().showText(50)
                ...
                .text("A Crushing Wheel with Efficiency enchantments can pulverize items faster")
            idle(70)
            ...
            overlay().showText(50)
                ...
                .text("The pulverizing speed increases based on the combined enchantment levels of both Crushing Wheels")
            idle(70)
